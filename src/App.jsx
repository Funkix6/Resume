...
const App = () => {
    return(
      <div className="bg-gradient flex h-screen">
        <div className="flex w-full m-10 bg-[#FEEAFA] shadow-xl rounded" >
          <div className="flex flex-col h-full bg-[#DEE2FF] shadow-md">
            ...
            <div className="flex flex-col w-auto h-full m-5 rounded-xl bg-[#FEEAFA] shadow-md">
              ...
              <div className="flex w-full justify-start p-2 space-x-3 border-b items-center">
              ...
              <div className="flex w-full justify-start p-2 space-x-3 border-b items-center">
                <SiGithub size={24} /> <a className="hover:text-blue-500" href="https://github.com/Funkix6" target="_blank"> Funkix6 </a>
              </div>
            </div>
          </div>
        </div>
